<template>
  <div class="main user-layout-forgetpwd">
    <h3>
      <span>忘记密码</span>
    </h3>
    <a-form ref="formForgetPwd" :form="form" id="formForgetPwd">
      ...
      <a-form-item style="margin-top:24px">
        <a-button
          ...
          type="primary"
          htmlType="submit"
          class="forgetPwd-button"
          :loading="state.forgetPwdBtn"
          :disabled="state.forgetPwdBtn"
